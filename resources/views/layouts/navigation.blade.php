    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <!-- Navigation Links -->
                @php
                    $allowed = app(App\Services\ModuleAccessPolicy::class)->allowedModules(auth()->user()->role ?? '');
                @endphp
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    @if(in_array('finance', $allowed))
                        <x-nav-link :href="route('finance.orders')" :active="request()->routeIs('finance.*')">
                            {{ __('Finance') }}
                        </x-nav-link>
                    @endif
